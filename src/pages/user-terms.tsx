    ...
    return (
        <div className="flex flex-col justify-normal items-start gap-5 md:gap-10">
            <div className="flex flex-col justify-normal items-start gap-3">
                ...
                <Typography>En utilisant <span className="font-semibold">QuickUpdate</span> , vous acceptez de respecter les présentes Conditions d'Utilisation. Veuillez lire attentivement ces conditions avant d'utiliser notre service.</Typography>
            </div>
            <div className="flex flex-col justify-normal items-start gap-3">
                <Typography variant="h5" className="font-semibold">Services fournis</Typography>
                <Typography><span className="font-semibold">QuickUpdate</span> vous permet de :</Typography>
                <Typography tag="div">
            ...
            <div className="flex flex-col justify-normal items-start gap-3">
                ...
                <Typography>L'utilisation de <span className="font-semibold">QuickUpdate</span> nécessite un compte Google valide pour l'authentification. Vous devez également autoriser l'application à accéder à vos contacts pour que nous puissions les importer et les mettre à jour.</Typography>
            </div>
            <div className="flex flex-col justify-normal items-start gap-3">
                <Typography className="font-semibold" variant="h5">Responsabilités de l'utilisateur</Typography>
                <Typography>Vous êtes responsable de la véracité des informations que vous fournissez à <span className="font-semibold">QuickUpdate</span> , notamment vos informations de contact et votre compte Google. Vous vous engagez à ne pas utiliser notre service de manière illégale, nuisible ou contraire à l'éthique.</Typography>
            </div>
            <div className="flex flex-col justify-normal items-start gap-3">
                <Typography className="font-semibold" variant="h5">Propriété intellectuelle</Typography>
                <Typography>Tout le contenu de <span className="font-semibold">QuickUpdate</span> , y compris les textes, graphiques, logos, images, et logiciels, est la propriété de<span className="font-semibold">QuickUpdate</span>  ou de ses partenaires et est protégé par des droits d'auteur et des lois sur la propriété intellectuelle. Vous n'êtes pas autorisé à copier, distribuer ou exploiter ce contenu sans autorisation.</Typography>
            </div>
            <div className="flex flex-col justify-normal items-start gap-3">
                <Typography variant="h5" className="font-semibold">Limitation de responsabilité</Typography>
                <Typography>Nous nous efforçons de fournir un service fiable et sécurisé, mais nous ne pouvons garantir que <span className="font-semibold">QuickUpdate</span>  sera exempt d’erreurs ou d’interruptions. Nous ne sommes pas responsables des pertes ou dommages causés par l’utilisation de notre application.</Typography>
            </div>
            <div className="flex flex-col justify-normal items-start gap-3">
                <Typography variant="h5" className="font-semibold">Modifications des conditions</Typography>
                <Typography>Nous pouvons modifier ces Conditions d'Utilisation à tout moment. Nous vous informerons de toute modification en publiant la nouvelle version sur cette page. Votre utilisation continue de <span className="font-semibold">QuickUpdate</span> après une modification constitue votre acceptation des nouvelles conditions.</Typography>
            </div>
            <div className="flex flex-col justify-normal items-start gap-3">
                <Typography variant="h5" className="font-semibold">Résiliation</Typography>
                <Typography>Nous nous réservons le droit de suspendre ou de résilier votre accès à <span className="font-semibold">QuickUpdate</span>  si vous enfreignez les présentes conditions.</Typography>
            </div>
        </div>
    )
}
